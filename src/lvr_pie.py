...
sizes = [cf.calrange(data,0,20), cf.calrange(data,20,30), cf.calrange(data,30,40), cf.calrange(data,40,50), cf.calrange(data,50,60), cf.calrange(data,60,70), cf.calrange(data,70,80), cf.calrange(data,80,10000)]
